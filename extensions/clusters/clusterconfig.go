...
type ClusterConfig struct {
	...
	ClusterAgent         *v1.AgentDeploymentCustomization        `json:"clusterAgent" yaml:"clusterAgent"`
	FleetAgent           *v1.AgentDeploymentCustomization        `json:"fleetAgent" yaml:"fleetAgent"`
